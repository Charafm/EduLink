...
{
    public class IdentityContextFactory : IdentityContextFactory<IdentityContext>
    {
    ...
    public class IdentityContextFactory<TContext> : AbstractContextFactory<TContext>
