...
namespace SchoolSaas.Infrastructure.Identity.Context
{
        ...
        >, IIdentityContext
    {
        ...
        public IdentityContext(ITenantAccessor tenantAccessor,
            ICurrentUserService currentUserService, IDateTime dateTime, DbContextOptions<IdentityContext> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            {
                ReflectionHelper.InvokeGenericMethod(typeof(IdentityContext), this, nameof(AddDeletedQueryFilter),
                ...
                .Where(e => typeof(ITenantAware).IsAssignableFrom(e.ClrType)))
            {
                if (typeof(IDeletableEntity).IsAssignableFrom(entity.ClrType))
                    ReflectionHelper.InvokeGenericMethod(typeof(IdentityContext), this, nameof(AddTenantIdAndDeletedQueryFilter),
                        new Type[] { entity.ClrType }, builder);
                else
                    ReflectionHelper.InvokeGenericMethod(typeof(IdentityContext), this, nameof(AddTenantIdQueryFilter),
                        new Type[] { entity.ClrType }, builder);
            }
        }
    }
