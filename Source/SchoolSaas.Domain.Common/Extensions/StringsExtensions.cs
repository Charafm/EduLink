...
namespace SchoolSaas.Domain.Common.Extensions
{
    /// <summary>
    ...
    public static class StringExtensions
    {
        ...
        public static string FirstToUpperCase(this string str)
        {
        ...
        public static string FirstToLowerCase(this string str)
        {
            if (string.IsNullOrEmpty(str))
                return str;
            if (str.Length == 1)
