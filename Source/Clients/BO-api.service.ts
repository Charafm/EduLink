...
export interface IEnrollmentClient {
    ...
    getEnrollmentRequests(status: EnrollmentRequestStatusEnum | null | undefined, branchId: string | null | undefined, searchTerm: string | null | undefined, page: number | undefined, pageSize: number | undefined): Promise<PagedResultOfEnrollmentRequestDTO>;
...
export class EnrollmentClient implements IEnrollmentClient {
    ...
    getEnrollmentRequests(status: EnrollmentRequestStatusEnum | null | undefined, branchId: string | null | undefined, searchTerm: string | null | undefined, page: number | undefined, pageSize: number | undefined, cancelToken?: CancelToken): Promise<PagedResultOfEnrollmentRequestDTO> {
