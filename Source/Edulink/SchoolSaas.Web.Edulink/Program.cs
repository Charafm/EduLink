...
using SchoolSaas.Application.Edulink;
using SchoolSaas.Infrastructure.Common;
using SchoolSaas.Infrastructure.Edulink;
...
builder.AddSchoolWebApplication("edulink", services =>
{
    builder.Services.AddEdulinkApplication();
    builder.Services.AddInfrastructure(builder.Configuration);
    builder.Services.AddAuthentication(builder.Configuration);
    builder.Services.AddIdentityInfrastructure(builder.Configuration);
    builder.Services.AddEdulinkInfrastructure(builder.Configuration);
